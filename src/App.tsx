    ...
    <main className="chat">
      ...
      >
        ...
        <section style={{ padding: "2rem", textAlign: "center" }}>
          ...
          <h2 style={{ marginTop: "2rem" }}>📚 Class 12 Formula Reference</h2>
          ...
          <div style={{ display: "flex", justifyContent: "center", gap: "1rem", marginBottom: "1rem" }}>
            <button
              ...
              className={activeTab === "physics" ? "active-tab" : ""}
            >
              Physics
            </button>
            <button
              ...
              className={activeTab === "chemistry" ? "active-tab" : ""}
            >
              Chemistry
            </button>
            <button
              ...
              className={activeTab === "maths" ? "active-tab" : ""}
            >
              Maths
            </button>
          </div>
